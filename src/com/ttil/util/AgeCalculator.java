...
public class AgeCalculator
{
	...
	public static void main(String[] args) throws ParseException
	{
		...
		Date birthDate = sdf.parse("30-12-1996"); //Yeh !! It's my date of birth <img src="http://howtodoinjava.com/wp-includes/images/smilies/icon_smile.gif" alt=":-)" class="wp-smiley"> 
