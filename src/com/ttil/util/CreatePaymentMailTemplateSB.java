...
public class CreatePaymentMailTemplateSB implements Runnable {

	AsyncContext asyncContext;
	ApplicationFormBean applicationFormBean=null;
	String ipaddress,sessioId,browser;
	public CreatePaymentMailTemplateSB(AsyncContext asyncContext,ApplicationFormBean applicationFormBean,String ipaddress,String browser,String sessioId) {
		...
		try {
			...
			if(applicationFormBean.getEmailaddress()!=null)
			{
				...
				if(verifyStatus>0 || verifyStatus==-1 || verifyStatus==-2)
				{
					...
					email_content=email_content+"<div id='text2'><p><b><u>The Registration Form filled by you is PROVISIONALLY SUBMITTED and APPLICATION FEE Received</u></b></p>  <b><p style='color:black'>Please Keep this Email as a Reference</p></b>	"
							...
							+ "<p><b>Application Fee : INR. "+applicationFormBean.getFee_amount()+".00  Received </b> </p>"
							+ "<p>------------------------------------------------------------------------------------</p>";
					...
					AWSJavaMailSample awsJavaMailSample=new AWSJavaMailSample(emailaddress,"PAYMENT CONFIRMATION for SSB RECRUITMENT FOR 338/RC/SSB/Combined Advt./2020",template.toString(),applicationFormBean.getMobileNumber());
