...
public class CreateForgotPasswordMailTemplateSB implements Runnable {

	AsyncContext asyncContext;
	ApplicationFormBean applicationFormBean=null;
	String ipaddress,sessioId,browser;
	public CreateForgotPasswordMailTemplateSB(AsyncContext asyncContext,ApplicationFormBean applicationFormBean,String ipaddress,String browser,String sessioId) {
		...
		try {
			...
			if(applicationFormBean.getEmailaddress()!=null)
			{
				...
				if(verifyStatus>0 || verifyStatus==-1 || verifyStatus==-2)
				{
					...
					email_content=email_content+"<body> <h4 style='text-align: center;color: blue;font-family: sans-serif;font-size: 20px;'>PLEASE DO NOT REPLY TO THIS EMAIL</h4> <div id='text1'> <p><span style='text-align: center; color: red; font: bold; margin-left: 10px; font-size: 16px;'>This is an automated email sent by SASHASTRA SEEMA BAL RECRUITMENT  </span></p> <b><p>Following are the details submitted by you in the Registration Form filled for Post of "+ESAPI.encoder().canonicalize(applicationFormBean.getPost_applied())+" EXAMINATION, 2018</p></b> </div>";
					email_content=email_content+"<div id='text2'><p><b><u>The Registration Form filled by you is PROVISIONALLY SUBMITTED </u></b></p>  <b><p style='color:black'>Please Keep this Email as a Reference</p></b>	"
							...
							+ "<p>and</p>"
							+ "<p>Password : "+applicationFormBean.getPassword()+"</p>"
							+ "<p>------------------------------------------------------------------------------------</p>";
					...
					AWSJavaMailSample awsJavaMailSample=new AWSJavaMailSample(emailaddress,"REGISTRATION ID AND PASSWORD of SSB RECRUITMENT FOR "+applicationFormBean.getPost_applied()+" EXAMINATION, 2018",template.toString(),applicationFormBean.getMobileNumber());
