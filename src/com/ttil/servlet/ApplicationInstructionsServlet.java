...
public class ApplicationInstructionsServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
	{
		...
		try{
			/*if(requestFrom!=null && "menu".equalsIgnoreCase(requestFrom))
			{*/
				rd=req.getRequestDispatcher("/pages/instructions.jsp");
				rd.forward(req, res);
			/*}else{
