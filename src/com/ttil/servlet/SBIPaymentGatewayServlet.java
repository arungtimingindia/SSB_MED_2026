			...
			if(appDataBean!=null && appDataBean.getTransactionid()==transactionid){
				...
				if(responseId>=0){
					...
					if(order_id>0){
						...
						String EncryptTrans="";
						String requestParameter="1000420|DOM|IN|INR|"+appDataBean.getFee_amount()+"|"+transactionid+"|https://applyssb.com/SSB_ADVT_MED_2026_EDIT/sbisuccess|https://applyssb.com/SSB_ADVT_MED_2026_EDIT/sbifail|SBIEPAY|"+order_id+"|"+transactionid+"|NB|ONLINE|ONLINE";
//						String returnUrl=appDataBean.isEdit()?"https://applyssb.com/SSB_MEDICAL_25_EDIT/sbisuccess":"https://applyssb.com/SSB_CT_25/sbisuccess";
//						String returnFailUrl=appDataBean.isEdit()?"https://applyssb.com/SSB_MEDICAL_25_EDIT/sbifail":"https://applyssb.com/SSB_CT_25/sbifail";
//						String requestParameter="1000420|DOM|IN|INR|"+appDataBean.getFee_amount()+"|"+transactionid+"|"+returnUrl+"|"+returnFailUrl+"|SBIEPAY|"+order_id+"|"+transactionid+"|NB|ONLINE|ONLINE";
