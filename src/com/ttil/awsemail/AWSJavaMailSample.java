...
public class AWSJavaMailSample {
	 ...
	 */
	private static String FROM = "donotreply.ssbrectt@gmail.com";
	//private static String FROM = "tatamumbaimarathon@procam.in";
	...
	public static void main(String[] args) throws IOException {
		AWSJavaMailSample awsJavaMailSample=new AWSJavaMailSample("raju284@gmail.com","Hello World!","Hello World!",null);
		awsJavaMailSample.sendEmailViaAWS();
	}

	public AWSJavaMailSample(String TO,String SUBJECT,String BODY,String MOBILENUMBER)
	{
		AWSJavaMailSample.TO=TO;
		AWSJavaMailSample.SUBJECT=SUBJECT;
		AWSJavaMailSample.BODY=BODY;
		AWSJavaMailSample.MOBILENUMBER=MOBILENUMBER;
	}
	
	public void sendEmailViaAWS()
	{
		/*
		...
		try {
			...
			e.printStackTrace();
			//LogsGeneration.generateErrorLogsWithMobileNumber("AWSSendEmail AddressException Catch", TO+" - Caught an AddressException, which means one or more of your "					+ "addresses are improperly formatted.", MOBILENUMBER, null, null);
		} catch (MessagingException e) {
			e.printStackTrace();
			//LogsGeneration.generateErrorLogsWithMobileNumber("AWSSendEmail MessagingException Catch", TO+" - Caught a MessagingException, which means that there was a " + "problem sending your message to Amazon's E-mail Service check the " + "stack trace for more information.", MOBILENUMBER, null, null);
		}
	}
	/**
