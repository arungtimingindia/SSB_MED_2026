...
public class ApplicationFormDAO {
	...
	/**
	 * This will check any duplicate records exist with Mobile number or Email or Personal details like Name, fathername, mothername , DOB
	 * @param appFormBean
	 * @param postsBean
	 * @return
	 */
	public int checkMobileAndEmail(ApplicationFormBean appFormBean,PostsBean postsBean)
	{
		...
		try{
			...
			if(con!=null)
			{
				//query_check="select transactionid,mobileNumber,emailaddress from applicants WHERE  post_id=? and org_id=? and (mobileNumber=? or emailaddress=?)";
				//query_check="select transactionid,mobileNumber,emailaddress,fullname from applicants WHERE post_applied=? and application_status='FINISHED' and ((mobileNumber=? or emailaddress=?) or (fullname=? and father_name=? and mother_name=? and dob=? and community=?))";
				//query_check="select transactionid,mobileNumber,emailaddress,fullname from applicants WHERE post_applied=? and   ((mobileNumber=? or emailaddress=?) or (fullname=? and father_name=? and mother_name=? and dob=? and community=?))";
				...
				//pstmt1.setString(1, ESAPI.encoder().canonicalize(appFormBean.getPost_applied()));
				...
				pstmt1.setString(7, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getDob())));
		...
		catch(Exception e)
		{
			...
			/*if(appFormBean!=null)
				//LogsGeneration.generateErrorLogsWithMobileNumber("MobileVerifyDAO Catch", exceptionAsString, appFormBean.getMobileNumber(), null, null);
			else
				//LogsGeneration.generateErrorLogsWithMobileNumber("MobileVerifyDAO Catch", exceptionAsString, null, null, null);
			 */return -4;
		}
		finally{
			try{
	...
	public int saveData(ApplicationFormBean appFormBean,String ipaddress,int post_id,int org_id,String browser)
	{
		...
		try{
			...
			if(con!=null)
			{
				...
				{  
					...
					if("".equalsIgnoreCase(exam_passed_1) || "".equalsIgnoreCase(stream_1) || "".equalsIgnoreCase(university_1) || "".equalsIgnoreCase(edu_rollno_1) || "".equalsIgnoreCase(edu_certno_1) || "".equalsIgnoreCase(edu_date_issue_1) || "".equalsIgnoreCase(edu_marks_1) || "".equalsIgnoreCase(edu_year_1)){
						edu_qual_1=false;
					}
					if("".equalsIgnoreCase(exam_passed_2) || "".equalsIgnoreCase(stream_2) || "".equalsIgnoreCase(university_2) || "".equalsIgnoreCase(edu_rollno_2) || "".equalsIgnoreCase(edu_certno_2) || "".equalsIgnoreCase(edu_date_issue_2) || "".equalsIgnoreCase(edu_marks_2) || "".equalsIgnoreCase(edu_year_2)){
						edu_qual_2=false;
					}
					...
					String query_personal = "INSERT INTO personal_qualification (transactionid,registered_nursing_council,hospital_experience,tradesmen_certificate,autocad_experience,draughtsmanship_experience) VALUES (?,?,?,?,?,?)";
					PreparedStatement pstmtPersonal=con.prepareStatement(query_personal);
					pstmtPersonal.setInt(1, transaction_id);
					
					if(appFormBean.getNurse()=="") {
						pstmtPersonal.setNull(2, java.sql.Types.TINYINT);
					}
					else {
					pstmtPersonal.setBoolean(2, appFormBean.isNursing_council());
					}
					...
					if(appFormBean.isEx_serviceman())
					{
						...
						pstmt3.setString(3, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getExman_enrollment_date())));
						pstmt3.setString(4, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getExman_retirement_date())));
					...
					if(appFormBean.isGovt_service() || appFormBean.isEmployee_ssb()){
						...
						pstmt5.setString(3, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getEmp_date_since())));
						...
						pstmt5.setString(7, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getEmp_date_since2())));
					...
					if(appFormBean.isDebarment()){
						...
						pstmt2.setString(4, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getExamdate())));
						pstmt2.setString(5, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getDebarenddate())));
					...
					if(fir_cases){
						...
						pstmt2.setString(3, StringUtils.changeDateFormatYMD(ESAPI.encoder().canonicalize(appFormBean.getFirdate())));
				...
				//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO", "Connection is null in DAO", null, null, null);
				return -4;
			}
		}
		catch(Exception e)
		{
			...
			String exceptionAsString = sw.toString();
			/*if(appFormBean!=null)
				//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO Catch",exceptionAsString, appFormBean.getMobileNumber(), ipaddress, null);
			else
				//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO Catch", exceptionAsString, null, ipaddress, null);
			 */try{
				 con.rollback();
			 }
			 catch(Exception ex)
			 {
				 ...
				 //LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO Rollback",exceptionAsString, null, ipaddress, null);
			 }
			 return -4;
		}
		finally{
			...
			catch(Exception e)
			{
				...
				String exceptionAsString = sw.toString();
				/*if(appFormBean!=null)
					//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO in Finally", exceptionAsString, appFormBean.getMobileNumber(), null, null);
				else
					//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO in Finally", exceptionAsString, null, null, null);
				 */}
		}
	...
	/**
	 * This will update Photo & signature path into database and update the status as Finished
	 * @param appFormBean
	 * @param ipaddress
	 * @return
	 */
	...
	/** 
	 * This will create Order Id for Payments. New Record will insert into payment orders 
	 * @param appDataBean
	 * @param pgtype
	 * @param ipaddress
	 * @return
	...
	public int createPaymentOrder(AppDataBean appDataBean,String pgtype,String ipaddress)
	{
		...
		catch(Exception e)
		{
			...
			String exceptionAsString = sw.toString();
			/*if(appFormBean!=null)
				LogsGeneration.generateErrorLogs("PaymentSave Catch",exceptionAsString, appFormBean.getMobileNumber(),appFormBean.getTransactionid(), ipaddress, null);
			else
				LogsGeneration.generateErrorLogs("PaymentSave Catch", exceptionAsString, null,0, ipaddress, null);	*/
			try{
				con.rollback();
			}
			catch(Exception ex)
			...
			catch(Exception e)
			{
				...
				String exceptionAsString = sw.toString();
				/*if(appFormBean!=null)
					LogsGeneration.generateErrorLogs("PaymentSave Finally",exceptionAsString, appFormBean.getMobileNumber(),appFormBean.getTransactionid(), ipaddress, null);
				else
					LogsGeneration.generateErrorLogs("PaymentSave Finally", exceptionAsString, null,0, ipaddress, null);*/
			}
		}
		return order_id;
	...
	/**
	 * This method will save the HDFC payment response into payments table and update the status into applicants table 
	 * @param paymentBean
	 * @param appFormBean
	 * @param ipaddress
	 * @return
	...
	/**
	 * This method will save the SBI payment response into payments table and update the status into applicants table 
	 * @param paymentBean
	 * @param appFormBean
	 * @param ipaddress
	 * @return
	...
	public static  String  getCurrentDate()
	{
		...
		{
			//LogsGeneration.generateErrorLogsWithMobileNumber("DataSaveDAO getCurrentDate", e.getMessage(), null, null, null);
		}
		return currDate;
	}
}
