            ...
            <div class="row registration_sec">
                <div class="col-md-7" style="margin-left:200px;">
                    <div class="panel panel-default registrationBlock">
                        <div class="panel-heading">View Application Status</div>
                        ...
                        <div class="panel-body" style="min-height: 350px;">
                            ...
                            <form name="applicationSearch" id="applicationSearch" method="post" action="applicationSearch">
                                <div class="row">
                                 <input type="hidden" name="requestFrom" value="search"/>
                                 ...
                                 <div class="row">
                                  <div class="col-md-2"></div>
                                    ...
                                    <div class="col-md-5"><input type="password"  name="password" maxlength="20"  autocomplete="off" oncut="return false;" oncopy="return false;" onpaste="return false;" id="password" /></div>
                                </div>
                                 <div class="row">
                                  <div class="col-md-2"></div>
