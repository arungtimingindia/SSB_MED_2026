...
function communityText(){
   ...
   if(post_applied=="1"){
		$('#postCert').show();
	    $('#postCert').html("<b>Degree</b> or <b>Diploma</b> in Civil Engineering from a recognised University or Institute.");
	}
...
function firstPagevalidation(){
	...
	var date_ug="";
		...
		if(ep1!="" && ey1!="" && es1!="" && em1!="" && uni1!="" && stream1!="" && edm1!="" && eyear1!="")
		{
			...
			if(!dateDiff(em1,"19-06-2023")){
				alert("Matriculation Certificate Issued Date / Passing Year & Date should be less than or equal to 18-06-2023");
				return false;
			}
			if(eyear1<years_ssc){
					...
					return false;
						...
						if(ep2!="" && ey2!="" && es2!="" && em2!="" && uni2!="" && stream2!="" && edm2!="" && eyear2!=""){
							...
							if(!dateDiff(em2,"19-06-2023")){
								alert("10+2 Certificate Issued Date / Passing Year & Date should be less than or equal to 18-06-2023");
								return false;
							}
							if(edu1==true){
						 ...
						 if(edu3==false && post_applied!=2){
							...
							if(ep3!="" && ey3!="" && es3!="" && em3!="" && uni3!="" && stream3!="" && edm3!="" && eyear3!=""){
								...
								if(!dateDiff(em3,"19-06-2023")){
									alert("Graduation Certificate Issued Date / Passing Year & Date should be less than or equal to 18-06-2023");
									return false;
								}
								...
								if(ep4!="" && ey4!="" && es4!="" && em4!="" && uni4!="" && stream4!="" && edm4!="" && eyear4!=""){
									...
									if(!dateDiff(em4,"19-06-2023")){
										alert("Post Graduation Certificate Issued Date / Passing Year & Date should be less than or equal to 18-06-2023");
										return false;
									}
									...
									if(epd4!="" && eyd4!="" && esd4!="" && emd4!="" && unid4!="" && streamd4!="" && edmd4!="" && eyeard4!=""){
										...
										if(!dateDiff(emd4,"19-06-2023")){
											alert("Diploma Certificate Issued Date / Passing Year & Date should be less than or equal to 18-06-2023");
											return false;
										}
										...
										if(post_applied=="1" && edug3==true){
											alert("Either Degree or Diploma details are mandatory for selected post");
											return false;
										}
									}
									if(post_applied=="4"){
									...
									if(inter=="Science" && diploma=="general_nursing"){}
									else if(inter!="Science"){
									alert("You should have Science as your subject in 10+2");
									return false;
									}
									else if(diploma!="general_nursing"){
									alert("You should have General nursing as your subject in Diploma");
									return false;
									}
									...
									if(post_applied=="1"){
										...
										var diploma = $("#stream_5").val();
										if(degree=="civil_Engineering" || diploma=="civil_Engineering"){}
										else{
											alert("You should have Civil Engineering as your subject either in Graduation or in Diploma");
											return false;
										}
									}
	...
	function ageValidation(){
		  ...
		  if(exman=="true")
		{
		  ...
		  {
				var govtservice=AgeCaluclateFor2Dates(date_since,"18-06-2023");
				if(govtservice>=3)
				{
	...
	function getAge() {
		...
		document.getElementById('age_as_on').innerHTML = "Age as on (18-June-2023): (YY/MM/DD) "+ageString;
										...
										<table width="100%" border="0" align="center" cellpadding="5"
											...
											<!-- 	
												...
												<tr id="nursing" class="nursing">
													<td  align="left" valign="middle"><label style="font-weight:bold;">Whether registered with Central or State Nursing Council :<span style="color: red">*</span>  </label></td>
